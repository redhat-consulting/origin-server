...
spec_file = "rubygem-openshift-origin-routing-xha-activemq.spec"

Gem::Specification.new do |s|
  s.name        = "openshift-origin-routing-xha-activemq"
  ...
  s.files       += %w(README.md Rakefile Gemfile rubygem-openshift-origin-routing-xha-activemq.spec openshift-origin-routing-xha-activemq.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
