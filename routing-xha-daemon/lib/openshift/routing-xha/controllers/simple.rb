require 'rubygems'
require 'parseconfig'
require 'openshift/routing-xha/controllers/load_balancer'
...
module OpenShift
  ...
  class SimpleLoadBalancerController < LoadBalancerController
    ...
    class Pool < LoadBalancerController::Pool
      ...
      def add_alias alias_str, public_ip, public_port
        @aliases.push alias_str
        @lb_model.add_pool_alias @name, alias_str, public_ip, public_port
      end
